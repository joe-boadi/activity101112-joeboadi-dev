...
export function UpdateInvoice({ id }: { id: string }) {
  return (
    ...
    href={`/dashboard/invoices/${id}/edit`}
      className="rounded-md border border-base-content/20 p-2 hover:bg-base-300"
    >
...
export function DeleteInvoice({ id }: { id: string }) {
  ...
  return (
    <form action={deleteInvoiceWithId}>
      <button className="rounded-md border p-2  border-base-content/20 hover:bg-base-300">
